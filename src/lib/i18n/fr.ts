const fr = {
  ...
  homeHeroCycle1: "Transformez les résultats de labo en conseils clairs",
  homeHeroCycle2: "Interprétation sol et foliaire pour les producteurs",
  homeHeroCycle3: "Repartez à zéro ou reprenez où vous en étiez",
