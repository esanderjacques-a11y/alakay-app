const fr = {
  ...
  planning: {
    ...
    savedCalendarsTitle: "Calendriers enregistres",
    savedCalendarsDesc: "Ouvrez un calendrier nomme ou creez-en un nouveau pour cette saison.",
    newCalendar: "Nouveau calendrier",
    openSavedCalendar: "Ouvrir",
    saveCalendar: "Enregistrer le calendrier",
    saveCalendarAs: "Enregistrer sous…",
    renameCalendar: "Renommer",
    deleteCalendar: "Supprimer",
    calendarName: "Nom du calendrier",
    calendarNamePlaceholder: "ex. Printemps 2026 · Parcelle nord",
    noSavedCalendars: "Aucun calendrier enregistre. Creez-en un pour organiser les plans.",
    calendarSaved: "Calendrier enregistre.",
    confirmDeleteCalendar: "Supprimer ce calendrier et ses applications ?",
    backToCalendars: "Tous les calendriers",
