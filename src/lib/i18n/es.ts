const es = {
  ...
  homeWelcomeNew: "Bienvenido, {name}",
  homeWelcomeBack: "Bienvenido de nuevo, {name}",
  emailVerifiedWelcome:
    "Correo verificado. Bienvenido a CULTOSOL — ya puedes empezar.",
  ...
  waterQualityTitle: "Índices del agua de riego",
  waterQualityDesc:
    "Calculados con los métodos de EARTH Unidad 4 (Villaseñor): sales, RAS, dureza, Kelly y clase C–S del US Salinity Lab.",
  waterSaltConc: "Concentración de sales",
  waterRas: "RAS / SAR",
  waterHardness: "Dureza",
  waterKelly: "Índice de Kelly",
  waterClassCS: "Clase de agua (C–S)",
  waterSeverity: "Severidad",
  waterSeverityNone: "Ninguna",
  ...
  aboutIntro:
    "Comenzó en un salón de clases como una herramienta para tareas, evolucionó hacia una herramienta para interpretar análisis de suelo para productores, y ahora es una plataforma multifuncional.",
  ...
  aboutOurStoryBody:
    "Cultosol nació en una clase de ciencia del suelo, cuando hacía falta una herramienta más inteligente para ahorrar tiempo. Con el tiempo quedó claro que muchas personas, sobre todo pequeños productores, están perdiendo la oportunidad de producir de forma más eficiente y sostenible. Algunos no tienen una herramienta que puedan entender en su idioma. Otros simplemente no tienen acceso a este tipo de apoyo. La app aún no se usa de forma masiva, pero esa es la meta: que cualquiera pueda entenderla y usarla, sin importar su formación o su condición.",
  ...
  jackoSend: "Enviar",
  jackoNewChat: "Nuevo chat",
  jackoThinking: "Jacko está pensando…",
  jackoIntro:
    "¡Ey! Soy Jacko, tu copiloto en Cultosol. Tengo a mano tus valores, dosis y calendario… y también la historia de la app. ¿Por dónde arrancamos?",
  ...
  planning: {
    ...
    savedCalendarsDesc: "Abre un calendario con nombre o crea uno nuevo para esta temporada.",
    ...
    deleteCalendar: "Eliminar",
    calendarName: "Nombre del calendario",
    calendarNamePlaceholder: "ej. Primavera 2026 · Lote norte",
    noSavedCalendars: "Aún no hay calendarios guardados. Crea uno para organizar los planes.",
    calendarSaved: "Calendario guardado.",
    confirmDeleteCalendar: "¿Eliminar este calendario y sus aplicaciones?",
    backToCalendars: "Todos los calendarios",
    ...
    notificationsDesc:
      "Avisos de hoy y de las próximas horas — no de meses adelante. Las aplicaciones del calendario avisan unas 18 horas antes.",
    unreadCount: "{count} pendientes",
    allCaughtUp: "Estás al día",
    markAllRead: "Marcar todo leído",
    emptyNotifications: "Aún no hay recordatorios pendientes o próximos.",
    notifGroupUpcoming: "Próximas",
    notifGroupToday: "Hoy",
    ...
    notifSoon: "Pronto",
    notifSwipeHint: "Desliza a la derecha para eliminar",
    ...
    enablePhoneNotifications: "Notificaciones del teléfono",
    enablePhoneNotificationsAction: "Activar",
    phoneNotificationsHint:
      "Permite que Cultosol avise en este teléfono cuando una aplicación esté por vencer.",
    phoneNotificationsEnabled: "Alertas del teléfono activas",
    phoneNotificationsDenied:
      "Las notificaciones están bloqueadas. Actívalas en el navegador o en los ajustes del teléfono para Cultosol.",
  },
