...
const spanishSectionedReport = [
  ["FERTILIDAD FISICA"],
  ["ParÃ¡metro", "Resultado", "Unidades", "Muy Bajo", "Bajo", "Normal", "Alto", "Muy Alto", "MÃ©todo", "PNT"],
  ["Clase Textural", "Franca", "", "", "", "", "", "", "DensitometrÃ­a", "PE-2127"],
  ["Arcilla", "26", "%", "", "", "", "", "", "DensitometrÃ­a", "PE-2127"],
  ["Limo", "42", "%", "", "", "", "", "", "DensitometrÃ­a", "PE-2127"],
  ["Arena", "32.0", "%", "", "", "", "", "", "DensitometrÃ­a", "PE-2127"],
  ["FERTILIDAD"],
  ["ParÃ¡metro", "Resultado", "Unidades", "Muy Bajo", "Bajo", "Normal", "Alto", "Muy Alto", "MÃ©todo", "PNT"],
  ["Cond. ElÃ©ctrica (Ext. 1/5)", "204", "ÂµS/cm", "", "200", "", "400", "", "", "PE-2128"],
  ["pH (Extracto 1/2,5)", "5,80", "Unidades de pH", "", "6,50", "", "7,50", "", "", "PE-2128"],
  ["Materia OrgÃ¡nica", "1,83", "%", "", "1,20", "", "2,00", "", "CombustiÃ³n", "PE-2129"],
  ["FÃ³sforo Disponible Olsen", "29,2", "mg/kg", "", "20,0", "", "40,0", "", "Olsen", "PE-2125"],
  ["MICROELEMENTOS"],
  ["ParÃ¡metro", "Resultado", "Unidades", "Muy Bajo", "Bajo", "Normal", "Alto", "Muy Alto", "MÃ©todo", "PNT"],
...
const agrilabScannedAiTable = [
  ...
  ["No. Laboratorio", "LAB-7788", "Fecha recepciÃ³n", "2026-05-10", "Cultivo", "Banano"],
  ["Lote/Bloque", "Norte 1", "UbicaciÃ³n", "Matina"],
  ["Variable", "ExpresiÃ³n/Sigla", "Resultados", "Unidades", "Rango Medio", "Extractante/TÃ©cnica/Referencia"],
  ["pH", "pH H2O", "5.8", "", "5.5 - 7.0", "H2O"],
  ["FÃ³sforo", "P", "12", "mg/kg", "10 - 20", "Olsen"],
