const es = {
  ...
  homeHeroCycle1: "Convierta resultados de laboratorio en orientación clara",
  homeHeroCycle2: "Interpretación de suelo y foliar para productores",
  homeHeroCycle3: "Empiece de nuevo o continúe donde lo dejó",
