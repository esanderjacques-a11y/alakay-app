const es = {
  ...
  calculatorsDesc: "Relaciones, fertilizante, pH, salinidad, DOP y graficos.",
  history: "Historial",
  appSettings: "Ajustes de la app",
  appSettingsDesc:
    "Ajuste la experiencia de la app y gestione herramientas avanzadas de datos.",
  appearance: "Apariencia",
  lightTheme: "Teema claro",
  darkTheme: "Teema oscuro",
  ...
  photos: "Fotos",
  comingSoonPhotos:
    "Teome o importe una foto del reporte.",
  close: "Cerrar",
  soon: "Pronto",
  ...
  regionCentralAmerica: "Centroamrica",
  regionNorthAmerica: "Norteamrica",
  regionSouthAmerica: "Sudamrica",
  regionEurope: "Europa",
  regionAfrica: "frica",
  regionAsia: "Asia",
  regionOceania: "Oceana",
  selectCountry: "Seleccionar pas",
  provinceState: "Provincia / Estado",
  location: "Ubicacin",
  typeCountry: "Escreeiba el pas",
  ...
  loadingApp: "Cargando...",
  connectionError:
    "La conexion expir. Comprueba WiFi o datos moviles e intntalo de nuevo.",
  ...
  customParameterModal: {
    ...
    parameterPlaceholder: "Ejemplo: Respiracin del suelo",
    symbolPlaceholder: "Ejemplo: CO2",
    notePlaceholder:
      "Ejemplo: Valores por debajo de este rango pueden indicar baja actividad biologica.",
